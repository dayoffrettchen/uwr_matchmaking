...
const SCHEMA_STATEMENTS = [
  ...
  "ALTER TABLE matches ADD COLUMN IF NOT EXISTS training_id integer",
  "ALTER TABLE matches ADD COLUMN IF NOT EXISTS played_at timestamptz NOT NULL DEFAULT now()",
  "ALTER TABLE matches ADD COLUMN IF NOT EXISTS team_1_score integer",
  "ALTER TABLE matches ADD COLUMN IF NOT EXISTS team_2_score integer",
  "ALTER TABLE matches ADD COLUMN IF NOT EXISTS status text NOT NULL DEFAULT 'draft'",
  ...
  "ALTER TABLE match_players ADD COLUMN IF NOT EXISTS match_id integer",
  ...
  "ALTER TABLE match_players ADD COLUMN IF NOT EXISTS lineup_type text NOT NULL DEFAULT 'active'",
  "ALTER TABLE match_players ADD COLUMN IF NOT EXISTS rating_before integer",
  "ALTER TABLE match_players ADD COLUMN IF NOT EXISTS rating_after integer",
  "ALTER TABLE match_players ADD COLUMN IF NOT EXISTS rating_delta integer",
  "ALTER TABLE match_players ADD COLUMN IF NOT EXISTS goals integer",
