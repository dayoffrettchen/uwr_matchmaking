...
export type MatchmakingDiagnostics = { effectiveStrengthDifference: number; startingLineupDifference: number; positionStrengthDifference: number; targetLineupPenalty: number; mandatorySamePositionCandidates: number; mandatorySamePositionCompleted: boolean; optionalLocalCandidates: number; optionalLocalCompleted: boolean; mandatorySamePositionRequiredCandidates: number; mandatorySamePositionAttempted: boolean; optionalLocalAttempted: boolean; mandatorySamePositionSweepsStarted: number; mandatorySamePositionSweepsCompleted: number }
